...
namespace jej
{
	...
	void RenderSystem::_useShader(const ShaderComponent& shaderComp) const
	{
		...
		else
		{
			...
			//TODO: Ask Eetu how this works, cause it's midnight and you wanna sleep//Messenger::Add(Messenger::MessageType::Error("Shader has zero attributes, shader parent ID: " + parentID));
		}
	}
	//////////////////////////////////////////
