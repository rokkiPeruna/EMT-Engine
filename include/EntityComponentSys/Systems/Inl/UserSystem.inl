...
bool UserSystem::AddComponent(Entity& p_entity, const ComponentType p_compType, Args ... p_args)
{
...
template <typename T>
T* UserSystem::GetComponentPtr(Entity& p_entity, const ComponentType p_compType)
{
...
template <typename T>
const T* UserSystem::GetComponentPtr(const Entity& p_entity, const ComponentType p_compType) const
{
    static_assert(std::is_base_of<Component, T>::value, "Tried to get component that doesn't inherit from Component.");
